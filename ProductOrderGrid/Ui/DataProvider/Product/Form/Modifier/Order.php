 ...
 * @since 100.1.0
 */
class Order extends AbstractModifier
{
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'dataScope' => 'order_index_listing',
                                'externalProvider' => 'order_index_listing.order_index_listing_data_source',
                                'selectionsProvider' => 'order_index_listing.order_index_listing.product_columns.ids',
                                'ns' => 'order_index_listing',
