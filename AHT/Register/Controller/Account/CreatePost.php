...
namespace AHT\Register\Controller\Account;
...
use AHT\Register\Model\CustomerCompanyFactory;
...
class CreatePost extends AbstractAccount implements CsrfAwareActionInterface, HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            // $customer->setContactPhone($this->getRequest()->getParam('contact_phone'));
            // $customer->setContactPhone($this->getRequest()->getParam('contact_phone'));
            // $customer->setContactPhone($this->getRequest()->getParam('contact_phone'));
            $customer_id=$customer->getId();
            //create new customerCompanyFactory
            $company = $this->_customerCompanyFactory->create();
            $company->setContactPhone($this->getRequest()->getParam('contact_phone'));
            if($this->getRequest()->getParam('company_type')=='Other')
            {
                $company->setOrganizationName($this->getRequest()->getParam('organization_name'));
            }
            $company->setCompanyType($this->getRequest()->getParam('company_type'));
